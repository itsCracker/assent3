...
/**
 * This is the model class for table "vw_fileSearch".
 *
 ...
 */
class VwFileSearch extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['programs', 'federal_register_notice', 'standard_order', 'license_requirement', 'license_policy', 'call_sign', 'vessel_type', 'remarks', 'gross_tonnage', 'vessel_flag', 'vessel_owner', 'source_list_url', 'citizenships', 'dates_of_birth', 'nationalities', 'places_of_birth', 'source_information_url'], 'string', 'max' => 2500],

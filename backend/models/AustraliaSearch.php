...
use backend\models\Australia;

/**
 * AustraliaSearch represents the model behind the search form of `backend\models\Australia`.
 */
class AustraliaSearch extends Australia
{
    /**
     * {@inheritdoc}
     */
